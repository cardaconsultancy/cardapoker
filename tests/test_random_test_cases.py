...
class TestTexasHoldemGame(unittest.TestCase):
    if test_one:
        def test_devision_by_zero(self):
            ...
            careful_calculator_C = create_player("careful_calculator_C", "careful_calculator", Chips(4))
            completely_random_D = create_player("completely_random_D", "completely_random", Chips(197))
            ...
            test_cards = [Card("Q", "♣"), Card("7", "♦"), Card("6", "♥"), Card("K", "♦"), Card("4", "♥")]
            start_round(table=table, test_cards = test_cards)

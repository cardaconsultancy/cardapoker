...
def get_next_player(starting_players_and_seats, active_players, current_player):
    """
    ...
    starting_player_names = [player.name for player in starting_players_and_seats]
    logger.debug("Starting players: %s", starting_player_names)

    if not active_players or not starting_players_and_seats:
